...
train_file = r'c:\temp\adult.data'
test_file = r'c:\temp\adult.test'
...
#DEFINIENDO LAS COLUMNAS DE TIPO CATEGORIA
...
#DEFINIENDO LAS COLUMNAS DE TIPO CONTINUAS
...
#CATEGORIZAR VARIABLES REALES EN BUCKETS
